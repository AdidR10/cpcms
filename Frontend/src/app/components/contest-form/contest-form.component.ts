      ...
      if (this.isEdit && this.contestId) {
        ...
        this._contestService.updateContest(this.contestId, postData).subscribe({
          next: (val: any) => {
            ...
            this._snackbar.showSnackbar('Contest updated successfully', false);
          ...
          error: (err: any) => {
            ...
            this._snackbar.showSnackbar('Failed to update contest', false);
          },
        });
      } else {
        // Add new contest
        this._contestService.addContest(postData).subscribe({
          next: (val: any) => {
            ...
            this._snackbar.showSnackbar('New Contest Published', true);
            this._dialogRef.close(true);
            this._contestService.getContestList();
          },
          error: (err: any) => {
            ...
            this._snackbar.showSnackbar('Failed to publish contest', false);
          },
        });
      }
    }
